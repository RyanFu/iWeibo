    ...
    public function indexAction ()
    {
        if ($this->getParam ("tid")) {
            ...
            if ($this->getParam ("unlockall")) {
                if($this->_topicObj->unLockTopic ($_tids))
                {
            ...
            if ($this->getParam ("lockall")) {
                if($this->_topicObj->lockTopic ($_tids))
                {
    ...
    public function censorAction ()
    {
        if ($this->getParam ("opentid")) {
            ...
            if ($this->getParam ("unmaskall")) {
                ...
                if($this->_blogObj->unLockWallBlog ($_opentids))
                {
            ...
            if ($this->getParam ("maskall")) {
             ...
             if($this->_blogObj->lockWallBlog ($_opentids))
             {
    ...
    public function addAction ()
    {
        if (strlen (trim($this->getParam ('title'))) > 0) {
            ...
            if ($_startTime >= $_endTime) {
                ...
                $topic = array ();
                $topic['title'] = htmlspecialchars(trim($this->getParam ('title')), ENT_QUOTES);
                $topic['wall'] = 1;
