 ...
 * @since 2.0
 */
if(file_exists(HTDOCS_ROOT.'config/version.php'))
{
    include_once (HTDOCS_ROOT.'config/version.php');
}
...
class Core_Open_Opent
{
    ...
    function oAuthRequest($url, $method, $parameters, $multi = false)
    {
	   ...
	   //boss上报，很重要，不能丢失
	   if(!preg_match($RexChar,$url))
	   {
	  	    include_once (HTDOCS_ROOT.'config/version.php');
	   		$parameters['appfrom'] = 'iweibo'.IWEIBO_VERSION;
	   }
