...
INSERT INTO `iweibo2_component_banner` (`id`, `name`, `picture`, `description`, `start_time`, `end_time`, `url`) VALUES(NULL, 'iWeibo3.0beta', 'http://app.qpic.cn/mblogpic/8cc0dcc514b36b1584b0/2000', 'iWeibo3.0横空出世', 1308326400, 1598803200, 'http://t.qq.com/api_iweibo');
...
INSERT INTO `iweibo2_user_tiview` (`id`, `tname`, `notice`, `style`, `host`, `desc`, `direct`, `sdate`, `edate`, `dateline`) VALUES(1, '男篮微访谈', 0, 'a:7:{s:7:"outward";s:0:"";s:5:"cover";s:0:"";s:10:"background";s:0:"";s:6:"repeat";i:0;s:7:"bgcolor";s:0:"";s:9:"linkcolor";s:0:"";s:3:"vod";s:1:"0";}', 'weibotalk', '东亚男篮锦标赛正在南京如火如荼的举行，中国队在击败卫冕冠军韩国队之后挺进半决赛将对阵日本。腾讯体育邀请到了男篮三名球员于澍龙、孟铎、张博做客微访谈，想了解中国男篮更多？快上腾讯微博来提问吧！', 0, 1308142620, 1598803200, 1598803200);

--
-- 转存表中的数据 `iweibo2_user_tiview_join`
--

INSERT INTO `iweibo2_user_tiview_join` (`id`, `tid`, `uname`, `utype`, `dateline`) VALUES(NULL, 1, 'zhangbo81', 1, 1598803200);
INSERT INTO `iweibo2_user_tiview_join` (`id`, `tid`, `uname`, `utype`, `dateline`) VALUES(NULL, 1, 'yushulong219', 1, 1598803200);
INSERT INTO `iweibo2_user_tiview_join` (`id`, `tid`, `uname`, `utype`, `dateline`) VALUES(NULL, 1, 'weibotalk', 0, 1598803200);
INSERT INTO `iweibo2_user_tiview_join` (`id`, `tid`, `uname`, `utype`, `dateline`) VALUES(NULL, 1, 'CBAmengduo', 1, 1598803200);

--
-- 转存表中的数据 `iweibo2_user_tlive`
--

INSERT INTO `iweibo2_user_tlive` (`id`, `tname`, `title`, `notice`, `style`, `host`, `desc`, `direct`, `sdate`, `edate`, `dateline`) VALUES(1, '腾讯合作伙伴大会', '腾讯合作伙伴大会', 0, 'a:7:{s:7:"outward";s:0:"";s:5:"cover";s:0:"";s:10:"background";s:0:"";s:6:"repeat";i:0;s:7:"bgcolor";s:0:"";s:9:"linkcolor";s:0:"";s:3:"vod";s:1:"0";}', 'chenweihong', '腾讯在北京召开合作伙伴大会，和所有第三方合作伙伴共商开放大计。马化腾发表演讲提出面对互联网未来的“八个选择”，并宣布腾讯要打造一个规模最大、最成功的开放平台，扶持所有合作伙伴再造一个腾讯。', 0, 1308142080, 1598803200, 1598803200);

--
-- 转存表中的数据 `iweibo2_user_tlive_join`
--

INSERT INTO `iweibo2_user_tlive_join` (`id`, `tid`, `uname`, `utype`, `dateline`) VALUES(NULL, 1, 'martinlau', 1, 1598803200);
INSERT INTO `iweibo2_user_tlive_join` (`id`, `tid`, `uname`, `utype`, `dateline`) VALUES(NULL, 1, 'kaifulee', 1, 1598803200);
INSERT INTO `iweibo2_user_tlive_join` (`id`, `tid`, `uname`, `utype`, `dateline`) VALUES(NULL, 1, 'hyxing', 1, 1598803200);
INSERT INTO `iweibo2_user_tlive_join` (`id`, `tid`, `uname`, `utype`, `dateline`) VALUES(NULL, 1, 'huyanping', 1, 1598803200);
INSERT INTO `iweibo2_user_tlive_join` (`id`, `tid`, `uname`, `utype`, `dateline`) VALUES(NULL, 1, 'chenweihong', 0, 1598803200);
