...
<h3>站点设置</h3>
<ul class="tab1">
<li class="current"><a href="javascript:;"><span>常规设置</span></a></li>
<li><a href="/admin/config/loginface"><span>外观设置</span></a></li>
</ul>
</div>
<form action="/admin/config/site?postFlag" method="post" onsubmit="return $.checkForm(this)" enctype="multipart/form-data" >
    <table class="tb tb2">
        <tr>
        ...
        <tr class="noborder">
            ...
            <td class="vtop tips2"><span info="config[basic][site_name]"></span>将显示在浏览器窗口标题等位置</td>
        </tr>
         <tr>
