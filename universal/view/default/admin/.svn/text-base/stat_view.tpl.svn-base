...
'src', '<!--{$_resource}-->resource/flash/stat.swf?path=&settings_file=<!--{$_resource}-->resource/xml/stat_setting.xml&data_file=<!--{$_resource}-->index.php<!--{$pathurl}-->admin/stat/stat/sd/<!--{$sd}-->/ed/<!--{$ed}-->/stat[]/<!--{$opts}-->',
