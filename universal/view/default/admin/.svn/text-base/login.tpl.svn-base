...
<html>
    <head>
        <title>iWeibo3.0管理中心 - <!--{TO->cfg key="site_name" group="basic" default="iWeibo2.0"}--></title>
    ...
    <body scroll="no" style="background:none;">
        ...
        <div class="header">
            <div class="logo">iWeibo3.0管理中心</div>
            ...
            <div class="mainD" id="mainD">
                <form method="post" name="login" id="loginform" action="/admin/login/login">
                    ...
                    <table border="0" cellpadding="0"cellspacing="0">
                        ...
                        <!--{if $isCode}-->
                        <tr valign="top">
                            <th style="padding:8px 10px 0 0;">附加码</th>
                            <td><input type="text" id="gdkey" name="gdkey" class="txt" onfocus="reloadgd(document.getElementById('gdField'))" /><br/>
                            <img id="gdField" src="" gd="<!--{$_resource}--><!--{$_gdurl}-->" onclick="reloadgd(this, true)" alt="看不清？换一张" title="看不清？换一张" style="display: none;cursor: pointer;margin:6px 0;" />
							</td>
                            <td></td>
                        </tr>
                        <script>
        ...
        <div class="copyright">Powered by iWeibo 3.0 &copy; 1998-2011 Tencent.</div>
