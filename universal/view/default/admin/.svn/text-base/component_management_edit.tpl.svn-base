...
<form name="cpform" method="post" action="/admin/componentmgt/edit" id="cpform" >
    <table class="tb tb2">
        ...
        <tr class="noborder">
            ...
            <td><!--{ if $components.$component.model != 'Model_TodayRecommend'}--><input name="number" value="<!--{$componentSetting.component_number}-->" type="text" class="txt" /><!--{else}--><input name="number"   readonly="readonly" value="<!--{$componentSetting.component_number}-->" type="text" class="txt" /><!--{/if}--><!--{if $components.$component.desc}--><span class="warningTip">(<!--{$components.$component.desc}-->)</span><!--{/if}--></td>
        </tr>
        <tr>
