...
<div class="cuspages right">
    ...
    <form method="post" action="/admin/report/index" id="report_form">
        ...
        <select name="orderby">
            ...
            <option value="time" <!--{if isset($orderby) && $orderby== 'time'}--> selected="selected"<!--{/if}-->>举报时间</option>
            <option value="username" <!--{if isset($orderby) && $orderby== 'username'}--> selected="selected"<!--{/if}-->>举报人</option>
        </select>
        <select name="ordersc">
