...
<tr class="noborder">
    <td class="vtop rowform">
        <textarea  rows="6" ondblclick="textareasize(this, 1)" onkeyup="textareasize(this, 0)" name="tiview[desc]"  cols="50" class="tarea" datatype="Require" msg="请填写微访谈简介"><!--{$tiview.desc}--></textarea>
    </td>
    <td class="vtop tips2"><span info="tiview[desc]"></span></td>
</tr>
<tr class="noborder">
