...
<table class="tb tb2 fixpadding">
    ...
    <tr><td class="vtop td24 lineheight">程序版本</td><td class="lineheight smallfont">iWeibo<!--{$version}-->  <a href="http://open.t.qq.com//iweibo/" class="lightlink smallfont" target="_blank">查看最新版本</a> </td></tr>
    <tr><td class="vtop td24 lineheight">服务器软件</td><td class="lineheight smallfont"><!--{$smarty.server.SERVER_SOFTWARE}--> <!--{$phpversion}--></td></tr>
