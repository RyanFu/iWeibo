...
<html>
    ...
    <div class="wrapper content">
        <div class="contentleft fleft">
            <form name="form1" id="form1" method="post" action="/event/new/submit/1" target="newevent" class="regform eventform" method="post" onsubmit="return checkForm('form1');" enctype="multipart/form-data">
              ...
              <table border="0" align="center" cellpadding="10" cellspacing="0">
                ...
                <tr>
                  ...
                  <td align="left">
                    <input type="text" class="input_text" name="title" id="title"  value="<!--{$event.title}-->" datatype="Require" msg="标题不能为空!"/>
                ...
                <tr>
                  ...
                  <input type="text" class="input_text" name="phone" id="phone" value="<!--{$event.phone}-->" />
                  </td>
                </tr>
                <tr>
                  <th height="30" align="right">联系人</th>
                  <td align="left"><input type="text" class="input_text" name="realname" id="realname"  value="<!--{$event.realname}-->"/></td>
                </tr>
                <tr>
                  <th height="30" align="right"><span>*</span>活动地点</th>
                  <td align="left"><input type="text" class="input_text" name="addr" id="addr"  value="<!--{$event.addr}-->" datatype="Require" msg="活动地点不能为空!"/>
                  <span class="errors"></span></td>
                </tr>
                <tr>
                  <th height="30" align="right"><span>*</span>报名截止</th>
                  <td align="left"><input type="text" class="input_text" name="deadline" id="deadline"  value="<!--{$event.deadline}-->" onclick="showcalendar(event, this,true)" readonly="true" datatype="Require" msg="报名截止时间不能为空!" /> <a class="icon_data" href="javascript:void(0)" onclick="showcalendar(event, document.getElementById('deadline'),true)" ></a>
                  <span class="errors"></span></td>
                </tr>
                <tr>
                  <th height="30" align="right"><span>*</span>开始时间</th>
                  <td align="left"><input type="text" class="input_text" name="sdate" id="sdate" readonly="true" value="<!--{$event.sdate}-->" onclick="showcalendar(event, this,true)"  datatype="Require" msg="开始时间不能为空!" /> <a class="icon_data" href="javascript:void(0)" onclick="showcalendar(event, document.getElementById('sdate'),true)" ></a>
                  <span class="errors"></span></td>
                </tr>
                <tr>
                  <th height="30" align="right"><span>*</span>结束时间</th>
                  <td align="left"><input type="text" class="input_text" name="edate" id="edate" readonly="true" onclick="showcalendar(event,this,true)" value="<!--{$event.edate}-->" datatype="Require" msg="结束时间不能为空!"/> <a class="icon_data" href="javascript:void(0)" onclick="showcalendar(event, document.getElementById('edate'),true)"></a>
                  <span class="errors"></span>
                  </td>
                </tr>
                <tr>
                  <th height="30" align="right" valign="top">人均费用</th>
                  <td align="left">
                  <!--{if $event.cost == 0}-->
                    <input type="radio" checked name="cost"  value="0" /> <label>免费</label><br/>
                    <input type="radio" name="cost" value="1"/>
                    <input type="text" class="input_text" name="money" id="money" disabled="true" onblur="this.value=this.value==''?0:(parseFloat(/^\D+$/.test(this.value)?0:this.value).toFixed(2));" value="0"/>
                <!--{else}-->
                    <input type="radio"  name="cost" value="0" /> <label>免费</label><br/>
                    <input type="radio" checked name="cost" value="1"/>
                    <input type="text" class="input_text" name="money" id="money" onblur="this.value=this.value==''?0:(parseFloat(/^\D+$/.test(this.value)?0:this.value).toFixed(2));" value="<!--{$event.cost}-->"/>
                <!--{/if}-->
                <label>元</label>
                 </td>
                </tr>
                <tr>
                  ...
                  <td align="left"><input type="checkbox" name="contact" id="contact" <!--{if $event.contact}-->checked<!--{/if}--> value="1"/> <label for="contact">要求参与者填写联系方式和简单说明</label></td>
                </tr>
                <tr>
