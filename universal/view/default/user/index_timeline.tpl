    ...
    <div class="wrapper content">
        <div class="contentleft fleft">
            ...
            <div class="moduletitle">
                ...
                <span class="fright">
                    <input type="checkbox" class="timelinefilter" data-filter="/utype/1" <!--{if $utype==1}-->checked<!--{/if}--> id="utype1"/><label for="utype1">原创</label>
                    <input type="checkbox" class="timelinefilter" data-filter="/ctype/4" <!--{if $ctype==4}-->checked<!--{/if}--> id="utype4"/><label for="utype4">图片</label>
                </span>
            </div>
