...
<html>
    ...
    <div class="wrapper content">
        <div class="contentleft fleft">
            ...
            <form name="form1" method="post" action="/event/join/id/<!--{$event.id}-->/submit/1" target="newevent" class="regform eventform" enctype="multipart/form-data">
              ...
              <table border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td align="left" valign="top"><label class="joiner"><!--{$user.name}--></label></td>
                </tr>
                <tr>
                  <th height="43" align="right" valign="top">联系方式</th>
                  <td align="left" valign="top"><label for="contact"></label>
                  <input  name="contact" id="contact"  class="input_text" type="text"/></td>
                </tr>
                <tr>
                  <th height="43" align="right">人均费用</th>
                  <td align="left" valign="top">
                    <!--{if $event.cost == 0}--><big class="money">免费</big>
                    <!--{else}--><big class="money"><!--{$event.cost}--></big> <label>元</label>
                    <!--{/if}-->
