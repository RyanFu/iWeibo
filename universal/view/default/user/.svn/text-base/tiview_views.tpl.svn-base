...
<html>
    ...
    <style> 
    <!--{if $tiview.style.linkcolor}-->a{color:<!--{$tiview.style.linkcolor}-->;}<!--{/if}-->
    <!--{if $tiview.style.background||$tiview.style.bgcolor}-->
    body{background:url(<!--{$tiview.style.background}-->) <!--{if !$tiview.style.repeat}-->no-repeat<!--{/if}--> <!--{if $tiview.style.bgcolor}--><!--{$tiview.style.bgcolor}--><!--{/if}-->; filter:null;}
    ...
    <div class="wrapper content">
        ...
        <div class="textlisttit" title="热门话题"><big>&#10075;</big><label><!--{$tiview.tname}--></label><big>&#10076;</big></div>
        ...
        <strong>访谈时间：</strong>
        <p class="gray"><!--{$tiview.sdate|idate:"Y年m月d日 H:i"}--> 至 <!--{$tiview.edate|idate:"Y年m月d日 H:i"}--></p>
        <strong>访谈内容：</strong>
