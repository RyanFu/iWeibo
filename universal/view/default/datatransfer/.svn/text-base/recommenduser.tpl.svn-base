...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            .userlist li{float:left; margin:0 0 10px 0; white-space:nowrap;overflow:hidden;display:inline-block;width:76px;height:80px;text-align:center;}
            .box .userlist{margin:10px 0;clear:both;}
            .box .userlist img{border:1px solid <!--{$css.bordercolor}-->;padding:2px;display:block;}
            .box .userlist h3{font:12px normal;width:76px;overflow:hidden;text-align:center;margin:3px 0;}
                ...
                <ul class="userlist">
                    ...
                    <li>
                        <p>
                            ...
                            <!--{if $hasAccessToken && $user.isidol==0 && $user.name != $accessToken.name}-->
