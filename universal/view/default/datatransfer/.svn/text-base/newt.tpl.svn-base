...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            .iweibo{height:<!--{$css.height-2}-->px;border:1px solid <!--{$css.bordercolor}-->;margin-left:0px;width:<!--{$css.width-2}-->px;}
            ...
            .iweibo .tcontainer li .source{border:1px solid <!--{$css.bordercolor}-->;padding:3px 8px;margin:6px 0 0;}
            ...
            .iweibo .tcontainer a.user{font-weight:bold;}
        ...
        <div class="iweibo iweibo_more">
            ...
            <div class="tcontainer" id="tcontainer">
                <ul>
                    ...
                    <li>
                        <a href="<!--{$pathRoot}-->t/showt/tid/<!--{$timeline.id}-->" target="_blank" class="user">
                        <!--{$timeline.nick}-->
                        </a>
                        <!--{if $timeline.type==2}-->
                            <span>转播</span>
                        ...
                        <!--{elseif $timeline.type=="4"}-->
                            <span>对 <a href="<!--{$pathRoot}-->u/<!--{$timeline.source.name}-->" target="_blank" class="user"><!--{$timeline.source.nick}--></a> 说</span>
                        <!--{/if}-->
                        : <!--{$timeline.text}-->
                        
                        <!--{if $timeline.type==2 || $timeline.type==7}-->
                        <div class="source">
                            <a href="<!--{$pathRoot}-->t/showt/tid/<!--{$timeline.id}-->" target="_blank" class="user"><!--{$timeline.source.nick}--></a>：
