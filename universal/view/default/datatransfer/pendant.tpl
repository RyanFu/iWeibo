...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            .iweibo{height:<!--{$css.height-2}-->px;border:1px solid <!--{$css.bordercolor}-->;margin-left:0px;overflow-x:hidden;width:<!--{$css.width-2}-->px;}
            ...
            .iweibo .tcontainer a.user{font-weight:bold;font-size:12px;}
