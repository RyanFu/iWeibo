<div class="profile">
    ...
    <div class="info fleft">
        <span>听众<a href="/friend/follower" class="newnum" id="newfans"><big></big><em></em><small></small></a></span><a class="usehovereffect" href="/friend/follower"><!--{$user.fansnum}--></a>
        <span>收听</span><a class="usehovereffect" href="/friend/following"><!--{$user.idolnum}--></a>
        <span class="last">广播</span><a class="usehovereffect" href="/mine"><!--{$user.tweetnum}--></a>
    </div>
    <div class="namelink">
        <span><!--{$user.nick}--></span>
